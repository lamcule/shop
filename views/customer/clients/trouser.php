...
<head>
	...
	<link rel="stylesheet" type="text/css" href="views/css/trouser.css">
			...
			<div style="padding-top: 100px;" class="row">
				...
				<?php foreach ($trousers as $trouser): ?>
					<div class="col-xs-6 col-sm-3 detail-product">
						<div class="banner">
							<div class="btn01">
					            <a href="detail-product?id=<?=$trouser->id?>" title=""><img src="<?=$trouser->anh?>" alt="" class="img-responsive"></a>
					        </div>
					        <div class="itemProduct ivt">
								<i>   </i>
								<h3>
									<span style="font-family: none"><?=$trouser->tensanpham?></span>
								</h3>
								<span><?=$trouser->gia?></span>
							</div>
						</div>
					</div>
				<?php endforeach ?>
