...
<head>
	...
	<link rel="stylesheet" type="text/css" href="views/css/shirt.css">
			...
			<div style="padding-top: 100px;" class="row">
				...
				<?php foreach ($shirts as $shirt): ?>
					<div class="col-xs-6 col-sm-3 detail-product">
						<div class="banner">
							<div class="btn01">
					           <a href="detail-product?id=<?=$shirt->id?>" title=""><img src="<?=$shirt->anh?>" alt="" class="img-responsive"></a>
					        </div>
					        <div class="itemProduct ivt">
								<i>   </i>
								<h3>
									<span><?=$shirt->tensanpham?></span>
								</h3>
								<span><?=$shirt->gia?></span>
							</div>
						</div>
