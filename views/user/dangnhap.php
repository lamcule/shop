...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="views/public/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  ...
  <div class="login-box-body">
    <?php
      ...
      // } 
    ?>
    <form action="loginTK-user" method="post">
      <div class="form-group has-feedback">
        <input type="username" name="username" class="form-control" placeholder="User">
...
<!-- iCheck -->
<script src="views/public/plugins/iCheck/icheck.min.js"></script>
